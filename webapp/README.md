# The WebApp
This is a simple demo map webapp written using TypeScript, ReactJS, and Patternfly for style.
...
* Thanks to Eli for this example code: https://medium.com/react-courses/world-map-chart-with-react-d3-with-ts-468b05f35404
